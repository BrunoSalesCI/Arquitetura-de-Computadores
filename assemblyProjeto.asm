...
resultcordX real8 0.0
resultcordY real8 0.0
...
start:
	...
	WHILE_TRUE:
     ...
     terminar:
        ...
        invoke StrToFloat, addr [_input], addr [cordFuroXfinal]   ; envia para a pilha a coord X Inicial

        invoke WriteConsole, chaveSaida, addr texto1, sizeof texto1, addr write_count, NULL	;	imprime na tela
		invoke ReadConsole, chaveEntrada, addr _input, sizeof _input, addr write_c, NULL	;	Captura o dado pelo teclado
        invoke StrToFloat, addr [_input], addr [cordFuroXinicial]     ; envia para a pilha a coord X Final
